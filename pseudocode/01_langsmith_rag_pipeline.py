...
def build_vectorstore():
    ...
    if not data_path.exists():
        print("No knowledge base found at data/knowledge_base.txt or .md — using empty index")
...
def main():
    ...
    project = os.environ.get("LANGSMITH_PROJECT", "llmops-prompt-versioning")
    print(f"{len(SAMPLE_QUESTIONS)} traces sent to LangSmith project '{project}'")
